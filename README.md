...
2. Into the extracted NoraxonToOpenSim_MATLABpipeline_GitHubPackage folder, deposit separate folders for each subject. Each folder should contain the .csv files, exported from Noraxon, for all trials from that subject. See screenshot below for an example of how the folder and data should be structured.
