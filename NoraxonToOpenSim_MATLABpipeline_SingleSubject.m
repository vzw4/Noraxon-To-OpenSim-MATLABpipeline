...
startTimeFirstTrial = str2double(trialStartArray{1,1});
scaleTimeRange = append(string(startTimeFirstTrial), ' ', string(startTimeFirstTrial + 0.01)); % Set the first 0.01 time for scaling
...
xmlFile.getElementsByTagName('time_range').item(1).setTextContent(scaleTimeRange);
